          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
					                  ...
					                  <tr>
                    <td height="20" colspan="15" align="center" bgcolor="#EEEEEE"class="tablestyle_title"> &nbsp;&nbsp;我的订单 &nbsp;</td>
                    </tr>
                   <tr>
                  ...
                  <tr>
                    ...
                    <td align="center" bgcolor="#FFFFFF">
                    	<a style="color:blue;" href="javascript:if(confirm('您确定要退票吗？')){window.location.href='/graduate/ReturnTicketServlet?order_id=${order.id}&train_num=${order.train_num }&user_id=${order.user_id }'}">退票</a>
                   	</td>
                  </tr>
                  </c:forEach>
                  </c:if>
