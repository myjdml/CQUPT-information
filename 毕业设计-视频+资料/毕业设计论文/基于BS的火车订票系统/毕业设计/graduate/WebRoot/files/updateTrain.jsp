...
<script language="JavaScript" type="text/javascript">
	...
	function checkRemainder(){
		...
		if(remainder==""){
			...
			$("remainderSpan").innerHTML="剩余票数必须大于0！ ";
			return false;
		}else if(amount < remainder){
			$("remainderSpan").innerHTML="剩余票数需小于等于额定票数！ ";
			return false;
		}else{
...
<body class="ContentBody">
  <form action="/graduate/UpdateTrainServlet" method="post"  name="form1"  onsubmit="return checkit();">
	<input type="hidden" name="trainNum" value="${train.train_num}">
<div class="MainDiv">
			...
			<TD width="100%">
				<fieldset style="height:100%;">
					  ...
					  <tr>
					    ...
					    <td><input name="train_num" id="train_num" type="text" class="text" style="width:154px" value="${train.train_num }" onblur="checkTrainNum();"/>
				         	<span class="red">* </span>
					  ...
					  <tr >
					    ...
					    <td>
					    	<textarea name="station" id="station" class="text" cols="45" rows="3" onblur="checkStation();" >${train.station}</textarea>
				        	<span class="red">* </span>
					  ...
					  <tr>
					    ...
					    <td>
				        	<textarea name="a_time" id="a_time" class="text" cols="45" rows="3" onblur="checkAtime();" >${train.a_time}</textarea>
				        	<span class="red">* </span>
					  ...
					  <tr>
					    ...
					    <td>
				        	<textarea name="g_time" id="g_time" class="text" cols="45" rows="3" onblur="checkGtime();" >${train.g_time}</textarea>
				        	<span class="red">* </span>
					  ...
					  <tr>
					    ...
					    <td>
				        	<textarea name="price" id="price" class="text" cols="45" rows="3" onblur="checkPrice();" >${train.price}</textarea>
				        	<span class="red">* </span>
					   ...
					   <tr>
					    ...
					    <td><input name="amount" id="amount" type="text" class="text" style="width:154px" value="${train.amount }" onblur="checkAmount();"/>
				         	<span class="red">* </span>
					 ...
					 <tr>
					    ...
					    <td><input name="remainder" id="remainder" type="text" class="text" style="width:154px" value="${train.remainder }" onblur="checkRemainder();"/>
				         	<span class="red">* </span>
